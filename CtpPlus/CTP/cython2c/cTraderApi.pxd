...
cdef extern from "ThostFtdcTraderApi.h":
    ...
    cdef cppclass CTraderApi "CThostFtdcTraderApi":
        ...
        #投资者商品组SPMM记录查询
        int ReqQryInvestorCommoditySPMMMargin(CThostFtdcQryInvestorCommoditySPMMMarginField *pQryInvestorCommoditySPMMMargin, int nRequestID) nogil except +

        #投资者商品群SPMM记录查询
        int ReqQryInvestorCommodityGroupSPMMMargin(CThostFtdcQryInvestorCommodityGroupSPMMMarginField *pQryInvestorCommodityGroupSPMMMargin, int nRequestID) nogil except +

        #SPMM合约参数查询
        int ReqQrySPMMInstParam(CThostFtdcQrySPMMInstParamField *pQrySPMMInstParam, int nRequestID) nogil except +

        #SPMM产品参数查询
        int ReqQrySPMMProductParam(CThostFtdcQrySPMMProductParamField *pQrySPMMProductParam, int nRequestID) nogil except +

        #SPBM附加跨品种抵扣参数查询
        int ReqQrySPBMAddOnInterParameter(CThostFtdcQrySPBMAddOnInterParameterField *pQrySPBMAddOnInterParameter, int nRequestID) nogil except +

        #RCAMS产品组合信息查询
        int ReqQryRCAMSCombProductInfo(CThostFtdcQryRCAMSCombProductInfoField *pQryRCAMSCombProductInfo, int nRequestID) nogil except +

        #RCAMS同合约风险对冲参数查询
        int ReqQryRCAMSInstrParameter(CThostFtdcQryRCAMSInstrParameterField *pQryRCAMSInstrParameter, int nRequestID) nogil except +

        #RCAMS品种内风险对冲参数查询
        int ReqQryRCAMSIntraParameter(CThostFtdcQryRCAMSIntraParameterField *pQryRCAMSIntraParameter, int nRequestID) nogil except +

        #RCAMS跨品种风险折抵参数查询
        int ReqQryRCAMSInterParameter(CThostFtdcQryRCAMSInterParameterField *pQryRCAMSInterParameter, int nRequestID) nogil except +

        #RCAMS空头期权风险调整参数查询
        int ReqQryRCAMSShortOptAdjustParam(CThostFtdcQryRCAMSShortOptAdjustParamField *pQryRCAMSShortOptAdjustParam, int nRequestID) nogil except +

        #RCAMS策略组合持仓查询
        int ReqQryRCAMSInvestorCombPosition(CThostFtdcQryRCAMSInvestorCombPositionField *pQryRCAMSInvestorCombPosition, int nRequestID) nogil except +

        #投资者品种RCAMS保证金查询
        int ReqQryInvestorProdRCAMSMargin(CThostFtdcQryInvestorProdRCAMSMarginField *pQryInvestorProdRCAMSMargin, int nRequestID) nogil except +

        #RULE合约保证金参数查询
        int ReqQryRULEInstrParameter(CThostFtdcQryRULEInstrParameterField *pQryRULEInstrParameter, int nRequestID) nogil except +

        #RULE品种内对锁仓折扣参数查询
        int ReqQryRULEIntraParameter(CThostFtdcQryRULEIntraParameterField *pQryRULEIntraParameter, int nRequestID) nogil except +

        #RULE跨品种抵扣参数查询
        int ReqQryRULEInterParameter(CThostFtdcQryRULEInterParameterField *pQryRULEInterParameter, int nRequestID) nogil except +

        #投资者产品RULE保证金查询
        int ReqQryInvestorProdRULEMargin(CThostFtdcQryInvestorProdRULEMarginField *pQryInvestorProdRULEMargin, int nRequestID) nogil except +
