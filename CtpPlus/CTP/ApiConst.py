...
#///TAS合约
ProductClass_TAS = b'7'
#///金属指数
ProductClass_MI = b'I'
#///期货单一合约
ProductClass_FutureSingle = b'1'
#///期权单一合约
ProductClass_OptionSingle = b'2'
#///可交易期货(含期货组合和期货单一合约)
ProductClass_APC_Futures = b'3'
#///可交易期权(含期权组合和期权单一合约)
ProductClass_APC_Options = b'4'
#///可下单套利组合
ProductClass_APC_TradingComb = b'5'
#///可申请的组合（可以申请的组合合约 包含可以交易的合约）
ProductClass_APC_UnTradingComb = b'6'
#///所有可以交易合约
ProductClass_APC_AllTrading = b'7'
#///所有合约（包含不能交易合约 慎用）
ProductClass_APC_All = b'8'
#///未上市
...
#///风控强平不验证资金
ForceCloseReason_Notverifycapital = b'8'
#///正常
...
#///普通持仓明细
SpecPosiType_Common = b'#'
#///TAS合约成交产生的标的合约持仓明细
SpecPosiType_Tas = b'0'
#///前成交价
...
#///终端信息上报
UserEventType_SubmitSysInfo = b'7'
#///转账
UserEventType_Transfer = b'8'
#///其他
...
#///期权对锁组合
CombinationType_OPL = b'7'
#///买备兑组合
CombinationType_BFO = b'8'
#///买入期权垂直价差组合
CombinationType_BLS = b'9'
#///卖出期权垂直价差组合
CombinationType_BES = b'a'
#///期货对锁组合
...
ClassType_FUTURE = b'1'
#///期货、现货期权合约
ClassType_OPTION = b'2'
#///组合合约
ClassType_COMB = b'3'
#///所有状态
Trading_ALL = b'0'
...
Trading_UNTRADE = b'2'
#///可交易
ProductStatus_tradeable = b'1'
#///不可交易
ProductStatus_untradeable = b'2'
#///交易可读
SyncDeltaStatus_Readable = b'1'
#///交易在读
SyncDeltaStatus_Reading = b'2'
#///交易读取完成
SyncDeltaStatus_Readend = b'3'
#///追平失败 交易本地状态结算不存在
SyncDeltaStatus_OptErr = b'e'
#///增加
ActionDirection_Add = b'1'
#///删除
ActionDirection_Del = b'2'
#///更新
ActionDirection_Upd = b'3'
#///轮询席位撤单
OrderCancelAlg_Balance = b'1'
#///优先原报单席位撤单
OrderCancelAlg_OrigFirst = b'2'
#///不控制
OpenLimitControlLevel_None = b'0'
#///产品级别
OpenLimitControlLevel_Product = b'1'
#///合约级别
OpenLimitControlLevel_Inst = b'2'
#///不控制
OrderFreqControlLevel_None = b'0'
#///产品级别
OrderFreqControlLevel_Product = b'1'
#///合约级别
OrderFreqControlLevel_Inst = b'2'
#///false
EnumBool_False = b'0'
#///true
EnumBool_True = b'1'
...
WithDrawParamID_CashIn = b'C'
#///只能平仓
InvstTradingRight_CloseOnly = b'1'
#///不能交易
InvstTradingRight_Forbidden = b'2'
#///标准算法收取双边
InstMarginCalID_BothSide = b'1'
#///单向大边
InstMarginCalID_MMSA = b'2'
#///新组保SPMM
InstMarginCalID_SPMM = b'3'
#///牛市看涨价差组合
RCAMSCombination_BUC = b'0'
#///熊市看涨价差组合
RCAMSCombination_BEC = b'1'
#///熊市看跌价差组合
RCAMSCombination_BEP = b'2'
#///牛市看跌价差组合
RCAMSCombination_BUP = b'3'
#///日历价差组合
RCAMSCombination_CAS = b'4'
#///使用初版交易所算法
PortfType_None = b'0'
#///SPBM算法V1.1.0_附加保证金调整
PortfType_AddOnHedge = b'1'
#///一般月份合约
InstrumentClass_Usual = b'1'
#///临近交割合约
InstrumentClass_Delivery = b'1'
#///非组合合约
InstrumentClass_NonComb = b'1'
#///持仓量和冻结量均无变化
ProdChangeFlag_None = b'0'
#///持仓量无变化，冻结量有变化
ProdChangeFlag_OnlyFrozen = b'1'
#///持仓量有变化
ProdChangeFlag_PositionChange = b'2'
