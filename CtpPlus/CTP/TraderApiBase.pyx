...
cdef class TraderApiBase:
    ...
    def buy_open(self, exchange_id, instrument_id, order_price, order_vol):
        ...
        :return:
        """
        return self.insert_order(exchange_id, instrument_id, order_price, order_vol, Direction_Buy, OffsetFlag_Open)
    ...
    def sell_close(self, exchange_id, instrument_id, order_price, order_vol, is_today=True):
        ...
        return self.insert_order(exchange_id, instrument_id, order_price, order_vol, Direction_Sell, offset_flag)
    ...
    def sell_open(self, exchange_id, instrument_id, order_price, order_vol):
        ...
        :return:
        """
        return self.insert_order(exchange_id, instrument_id, order_price, order_vol, Direction_Sell, OffsetFlag_Open)
    ...
    def buy_close(self, exchange_id, instrument_id, order_price, order_vol, is_today=True):
        ...
        """
        offset_flag = (OffsetFlag_CloseToday if is_today else OffsetFlag_CloseYesterday) if (exchange_id == b'SHFE' or exchange_id == b'INE') else OffsetFlag_Close
        return self.insert_order(exchange_id, instrument_id, order_price, order_vol, Direction_Buy, offset_flag)

    def insert_order(self, exchange_id, instrument_id, order_price, order_vol, direction, offset_flag):
        """
        ...
        try:
            ...
            self.write_log('insert_order', err_msg)
        finally:
            return result

    def cancel_order(self, exchange_id, instrument_id, order_ref, order_sysid=b''):
        """
        ...
        try:
            ...
            self.write_log('cancel_order', err_msg)
        finally:
            return result
    ...
    def OnRtnCFMMCTradingAccountToken(self, pCFMMCTradingAccountToken):
        self.write_log('OnRtnCFMMCTradingAccountToken', pCFMMCTradingAccountToken)
    ...
    # ############################################################################# #
    # ///请求查询交易员报盘机
    def ReqQryTraderOffer(self, pQryTraderOffer):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryTraderOffer)
                with nogil:
                    result = self.__api.ReqQryTraderOffer(<CThostFtdcQryTraderOfferField *> address, nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryTraderOffer', err_msg)
        finally:
            return result
    ...
    def OnRspQryTraderOffer(self, pTraderOffer, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryTraderOffer', pTraderOffer)
    ...
    # ############################################################################# #
    # ///查询最大报单数量请求
    def ReqQueryMaxOrderVolume(self, pQryMaxOrderVolume):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryMaxOrderVolume)
                with nogil:
                    result = self.__api.ReqQryMaxOrderVolume(<CThostFtdcQryMaxOrderVolumeField *> address, nRequestID)
        except Exception as err_msg:
    ...
    # ############################################################################# #
    # 请求查询分类合约
    def ReqQryClassifiedInstrument(self, pQryClassifiedInstrument):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryClassifiedInstrument)
                with nogil:
                    result = self.__api.ReqQryClassifiedInstrument(<CThostFtdcQryClassifiedInstrumentField *> address, nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryClassifiedInstrument', err_msg)
        finally:
            return result
    ...
    def OnRspQryClassifiedInstrument(self, pInstrument, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryClassifiedInstrument', pInstrument)
    ...
    # ############################################################################# #
    # 请求组合优惠比例
    def ReqQryCombPromotionParam(self, pQryCombPromotionParam):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryCombPromotionParam)
                with nogil:
                    result = self.__api.ReqQryCombPromotionParam(<CThostFtdcQryCombPromotionParamField *> address,
                                                              nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryCombPromotionParam', err_msg)
        finally:
            return result
    ...
    def OnRspQryCombPromotionParam(self, pCombPromotionParam, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryCombPromotionParam', pCombPromotionParam)
    ...
    # ############################################################################# #
    # 投资者风险结算持仓查询
    def ReqQryRiskSettleInvstPosition(self, pQryRiskSettleInvstPosition):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRiskSettleInvstPosition)
                with nogil:
                    result = self.__api.ReqQryRiskSettleInvstPosition(<CThostFtdcQryRiskSettleInvstPositionField *> address,
                                                                 nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRiskSettleInvstPosition', err_msg)
        finally:
            return result
    ...
    def OnRspQryRiskSettleInvstPosition(self, pRiskSettleInvstPosition, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRiskSettleInvstPosition', pRiskSettleInvstPosition)
    ...
    # ############################################################################# #
    # 风险结算产品查询
    def ReqQryRiskSettleProductStatus(self, pQryRiskSettleProductStatus):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRiskSettleProductStatus)
                with nogil:
                    result = self.__api.ReqQryRiskSettleProductStatus(<CThostFtdcQryRiskSettleProductStatusField *> address,
                                                                nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRiskSettleProductStatus', err_msg)
        finally:
            return result
    ...
    def OnRspQryRiskSettleProductStatus(self, pRiskSettleProductStatus, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRiskSettleProductStatus', pRiskSettleProductStatus)
    ...
    # ############################################################################# #
    # SPBM期货合约参数查询
    def ReqQrySPBMFutureParameter(self, pQrySPBMFutureParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPBMFutureParameter)
                with nogil:
                    result = self.__api.ReqQrySPBMFutureParameter(<CThostFtdcQrySPBMFutureParameterField *> address,
                                                            nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPBMFutureParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQrySPBMFutureParameter(self, pSPBMFutureParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPBMFutureParameter', pSPBMFutureParameter)
    ...
    # ############################################################################# #
    # SPBM期权合约参数查询
    def ReqQrySPBMOptionParameter(self, pQrySPBMOptionParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPBMOptionParameter)
                with nogil:
                    result = self.__api.ReqQrySPBMOptionParameter(<CThostFtdcQrySPBMOptionParameterField *> address,
                                                                  nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPBMOptionParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQrySPBMOptionParameter(self, pSPBMOptionParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPBMOptionParameter', pSPBMOptionParameter)
    ...
    # ############################################################################# #
    # SPBM品种内对锁仓折扣参数查询
    def ReqQrySPBMIntraParameter(self, pQrySPBMIntraParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPBMIntraParameter)
                with nogil:
                    result = self.__api.ReqQrySPBMIntraParameter(<CThostFtdcQrySPBMIntraParameterField *> address,
                                                                  nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPBMIntraParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQrySPBMIntraParameter(self, pSPBMIntraParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPBMIntraParameter', pSPBMIntraParameter)
    ...
    # ############################################################################# #
    # SPBM跨品种抵扣参数查询
    def ReqQrySPBMInterParameter(self, pQrySPBMInterParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPBMInterParameter)
                with nogil:
                    result = self.__api.ReqQrySPBMInterParameter(<CThostFtdcQrySPBMInterParameterField *> address,
                                                                 nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPBMInterParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQrySPBMInterParameter(self, pSPBMInterParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPBMInterParameter', pSPBMInterParameter)
    ...
    # ############################################################################# #
    # SPBM组合保证金套餐查询
    def ReqQrySPBMPortfDefinition(self, pQrySPBMPortfDefinition):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPBMPortfDefinition)
                with nogil:
                    result = self.__api.ReqQrySPBMPortfDefinition(<CThostFtdcQrySPBMPortfDefinitionField *> address,
                                                                 nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPBMPortfDefinition', err_msg)
        finally:
            return result
    ...
    def OnRspQrySPBMPortfDefinition(self, pSPBMPortfDefinition, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPBMPortfDefinition', pSPBMPortfDefinition)
    ...
    # ############################################################################# #
    # 投资者SPBM套餐选择查询
    def ReqQrySPBMInvestorPortfDef(self, pQrySPBMInvestorPortfDef):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPBMInvestorPortfDef)
                with nogil:
                    result = self.__api.ReqQrySPBMInvestorPortfDef(<CThostFtdcQrySPBMInvestorPortfDefField *> address,
                                                            nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPBMInvestorPortfDef', err_msg)
        finally:
            return result
    ...
    def OnRspQrySPBMInvestorPortfDef(self, pSPBMInvestorPortfDef, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPBMInvestorPortfDef', pSPBMInvestorPortfDef)
    ...
    # ############################################################################# #
    # 投资者新型组合保证金系数查询
    def ReqQryInvestorPortfMarginRatio(self, pQryInvestorPortfMarginRatio):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryInvestorPortfMarginRatio)
                with nogil:
                    result = self.__api.ReqQryInvestorPortfMarginRatio(<CThostFtdcQryInvestorPortfMarginRatioField *> address,
                                                                  nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryInvestorPortfMarginRatio', err_msg)
        finally:
            return result
    ...
    def OnRspQryInvestorPortfMarginRatio(self, pInvestorPortfMarginRatio, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryInvestorPortfMarginRatio', pInvestorPortfMarginRatio)
    ...
    def ReqQryInvestorProdSPBMDetail(self, pQryInvestorProdSPBMDetail):
        ...
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryInvestorProdSPBMDetail)
                with nogil:
                    result = self.__api.ReqQryInvestorProdSPBMDetail(<CThostFtdcQryInvestorProdSPBMDetailField *> address,
                                                                nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryInvestorProdSPBMDetail', err_msg)
        finally:
            return result
    ...
    def OnRspQryInvestorProdSPBMDetail(self, pInvestorProdSPBMDetail, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryInvestorProdSPBMDetail', pInvestorProdSPBMDetail)
    ...
    # ############################################################################# #
    # 投资者商品组SPMM记录查询
    def ReqQryInvestorCommoditySPMMMargin(self, pQryInvestorCommoditySPMMMargin):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryInvestorCommoditySPMMMargin)
                with nogil:
                    result = self.__api.ReqQryInvestorCommoditySPMMMargin(<CThostFtdcQryInvestorCommoditySPMMMarginField *> address,
                                                                    nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryInvestorCommoditySPMMMargin', err_msg)
        finally:
            return result

    # ############################################################################# #
    # ///投资者商品组SPMM记录查询响应
    def OnRspQryInvestorCommoditySPMMMargin(self, pInvestorCommoditySPMMMargin, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryInvestorCommoditySPMMMargin', pInvestorCommoditySPMMMargin)
    ...
    # ############################################################################# #
    # 投资者商品群SPMM记录查询
    def ReqQryInvestorCommodityGroupSPMMMargin(self, pQryInvestorCommodityGroupSPMMMargin):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryInvestorCommodityGroupSPMMMargin)
                with nogil:
                    result = self.__api.ReqQryInvestorCommodityGroupSPMMMargin(<CThostFtdcQryInvestorCommodityGroupSPMMMarginField *> address,
                                                                        nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryInvestorCommodityGroupSPMMMargin', err_msg)
        finally:
            return result

    # ############################################################################# #
    # ///投资者商品群SPMM记录查询响应
    def OnRspQryInvestorCommodityGroupSPMMMargin(self, pInvestorCommodityGroupSPMMMargin, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryInvestorCommodityGroupSPMMMargin', pInvestorCommodityGroupSPMMMargin)
    ...
    # ############################################################################# #
    # SPMM合约参数查询
    def ReqQrySPMMInstParam(self, pQrySPMMInstParam):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPMMInstParam)
                with nogil:
                    result = self.__api.ReqQrySPMMInstParam(<CThostFtdcQrySPMMInstParamField *> address, nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPMMInstParam', err_msg)
        finally:
            return result
    ...
    def OnRspQrySPMMInstParam(self, pSPMMInstParam, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPMMInstParam', pSPMMInstParam)
    ...
    # ############################################################################# #
    # SPMM产品参数查询
    def ReqQrySPMMProductParam(self, pQrySPMMProductParam):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPMMProductParam)
                with nogil:
                    result = self.__api.ReqQrySPMMProductParam(<CThostFtdcQrySPMMProductParamField *> address, nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPMMProductParam', err_msg)
        finally:
            return result
    ...
    def OnRspQrySPMMProductParam(self, pSPMMProductParam, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPMMProductParam', pSPMMProductParam)
    ...
    # ############################################################################# #
    # SPBM附加跨品种抵扣参数查询
    def ReqQrySPBMAddOnInterParameter(self, pQrySPBMAddOnInterParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQrySPBMAddOnInterParameter)
                with nogil:
                    result = self.__api.ReqQrySPBMAddOnInterParameter(<CThostFtdcQrySPBMAddOnInterParameterField *> address,
                                                               nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQrySPBMAddOnInterParameter', err_msg)
        finally:
            return result

    # ############################################################################# #
    # ///SPBM附加跨品种抵扣参数查询响应
    def OnRspQrySPBMAddOnInterParameter(self, pSPBMAddOnInterParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQrySPBMAddOnInterParameter', pSPBMAddOnInterParameter)
    ...
    # ############################################################################# #
    # RCAMS产品组合信息查询
    def ReqQryRCAMSCombProductInfo(self, pQryRCAMSCombProductInfo):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRCAMSCombProductInfo)
                with nogil:
                    result = self.__api.ReqQryRCAMSCombProductInfo(<CThostFtdcQryRCAMSCombProductInfoField *> address,
                                                                nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRCAMSCombProductInfo', err_msg)
        finally:
            return result
    ...
    def OnRspQryRCAMSCombProductInfo(self, pRCAMSCombProductInfo, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRCAMSCombProductInfo', pRCAMSCombProductInfo)
    ...
    # ############################################################################# #
    # RCAMS同合约风险对冲参数查询
    def ReqQryRCAMSInstrParameter(self, pQryRCAMSInstrParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRCAMSInstrParameter)
                with nogil:
                    result = self.__api.ReqQryRCAMSInstrParameter(<CThostFtdcQryRCAMSInstrParameterField *> address,
                                                                   nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRCAMSInstrParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQryRCAMSInstrParameter(self, pRCAMSInstrParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRCAMSInstrParameter', pRCAMSInstrParameter)
    ...
    # ############################################################################# #
    # RCAMS品种内风险对冲参数查询
    def ReqQryRCAMSIntraParameter(self, pQryRCAMSIntraParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRCAMSIntraParameter)
                with nogil:
                    result = self.__api.ReqQryRCAMSIntraParameter(<CThostFtdcQryRCAMSIntraParameterField *> address,
                                                                  nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRCAMSIntraParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQryRCAMSIntraParameter(self, pRCAMSIntraParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRCAMSIntraParameter', pRCAMSIntraParameter)
    ...
    # ############################################################################# #
    # RCAMS跨品种风险折抵参数查询
    def ReqQryRCAMSInterParameter(self, pQryRCAMSInterParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRCAMSInterParameter)
                with nogil:
                    result = self.__api.ReqQryRCAMSInterParameter(<CThostFtdcQryRCAMSInterParameterField *> address,
                                                                  nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRCAMSInterParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQryRCAMSInterParameter(self, pRCAMSInterParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRCAMSInterParameter', pRCAMSInterParameter)
    ...
    # ############################################################################# #
    # RCAMS空头期权风险调整参数查询
    def ReqQryRCAMSShortOptAdjustParam(self, pQryRCAMSShortOptAdjustParam):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRCAMSShortOptAdjustParam)
                with nogil:
                    result = self.__api.ReqQryRCAMSShortOptAdjustParam(<CThostFtdcQryRCAMSShortOptAdjustParamField *> address,
                                                                  nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRCAMSShortOptAdjustParam', err_msg)
        finally:
            return result

    # ############################################################################# #
    # ///RCAMS空头期权风险调整参数查询响应
    def OnRspQryRCAMSShortOptAdjustParam(self, pRCAMSShortOptAdjustParam, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRCAMSShortOptAdjustParam', pRCAMSShortOptAdjustParam)
    ...
    # ############################################################################# #
    # RCAMS策略组合持仓查询
    def ReqQryRCAMSInvestorCombPosition(self, pQryRCAMSInvestorCombPosition):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRCAMSInvestorCombPosition)
                with nogil:
                    result = self.__api.ReqQryRCAMSInvestorCombPosition(<CThostFtdcQryRCAMSInvestorCombPositionField *> address,
                                                                nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRCAMSInvestorCombPosition', err_msg)
        finally:
            return result

    # ############################################################################# #
    # ///RCAMS策略组合持仓查询响应
    def OnRspQryRCAMSInvestorCombPosition(self, pRCAMSInvestorCombPosition, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRCAMSInvestorCombPosition', pRCAMSInvestorCombPosition)
    ...
    # ############################################################################# #
    # 投资者品种RCAMS保证金查询
    def ReqQryInvestorProdRCAMSMargin(self, pQryInvestorProdRCAMSMargin):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryInvestorProdRCAMSMargin)
                with nogil:
                    result = self.__api.ReqQryInvestorProdRCAMSMargin(<CThostFtdcQryInvestorProdRCAMSMarginField *> address,
                                                                nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryInvestorProdRCAMSMargin', err_msg)
        finally:
            return result

    # ############################################################################# #
    # ///投资者品种RCAMS保证金查询响应
    def OnRspQryInvestorProdRCAMSMargin(self, pInvestorProdRCAMSMargin, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryInvestorProdRCAMSMargin', pInvestorProdRCAMSMargin)
    ...
    # ############################################################################# #
    # RULE合约保证金参数查询
    def ReqQryRULEInstrParameter(self, pQryRULEInstrParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRULEInstrParameter)
                with nogil:
                    result = self.__api.ReqQryRULEInstrParameter(<CThostFtdcQryRULEInstrParameterField *> address,
                                                            nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRULEInstrParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQryRULEInstrParameter(self, pRULEInstrParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRULEInstrParameter', pRULEInstrParameter)
    ...
    # ############################################################################# #
    # RULE品种内对锁仓折扣参数查询
    def ReqQryRULEIntraParameter(self, pQryRULEIntraParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRULEIntraParameter)
                with nogil:
                    result = self.__api.ReqQryRULEIntraParameter(<CThostFtdcQryRULEIntraParameterField *> address,
                                                            nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRULEIntraParameter', err_msg)
        finally:
            return result
    ...
    # ############################################################################# #
    # RULE跨品种抵扣参数查询
    def ReqQryRULEInterParameter(self, pQryRULEInterParameter):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryRULEInterParameter)
                with nogil:
                    result = self.__api.ReqQryRULEInterParameter(<CThostFtdcQryRULEInterParameterField *> address,
                                                            nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryRULEInterParameter', err_msg)
        finally:
            return result
    ...
    def OnRspQryRULEInterParameter(self, pRULEInterParameter, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryRULEInterParameter', pRULEInterParameter)
    ...
    # ############################################################################# #
    # 投资者产品RULE保证金查询
    def ReqQryInvestorProdRULEMargin(self, pQryInvestorProdRULEMargin):
        cdef int result = -1
        cdef size_t address = 0
        cdef int nRequestID
        try:
            nRequestID = self.__inc_req_id()
            if self.__api is not NULL:
                address = addressof(pQryInvestorProdRULEMargin)
                with nogil:
                    result = self.__api.ReqQryInvestorProdRULEMargin(<CThostFtdcQryInvestorProdRULEMarginField *> address,
                                                                 nRequestID)
        except Exception as err_msg:
            self.write_log('ReqQryInvestorProdRULEMargin', err_msg)
        finally:
            return result

    # ############################################################################# #
    # ///投资者产品RULE保证金查询响应
    def OnRspQryInvestorProdRULEMargin(self, pInvestorProdRULEMargin, pRspInfo, nRequestID, bIsLast):
        self.write_log('OnRspQryInvestorProdRULEMargin', pInvestorProdRULEMargin)
...
# ///请求查询交易员报盘机响应
cdef extern int TraderSpi_OnRspQryTraderOffer(self, CThostFtdcTraderOfferField *pTraderOffer,
                                                    CThostFtdcRspInfoField *pRspInfo,
                                                    int nRequestID,
                                                    bool bIsLast) except -1:
    try:
        self.OnRspQryTraderOffer({} if pTraderOffer is NULL else TraderOfferField.from_address(<size_t> pTraderOffer).to_dict(),
                                 {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                 nRequestID,
                                 bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryTraderOffer', err_msg)
    return 0

# ///查询最大报单数量响应
cdef extern int   TraderSpi_OnRspQryMaxOrderVolume(self, CThostFtdcQryMaxOrderVolumeField *pQueryMaxOrderVolume,
                                                         CThostFtdcRspInfoField *pRspInfo,
                                                         int nRequestID,
                                                         bool bIsLast) except -1:
    try:
        self.OnRspQueryMaxOrderVolume({} if pQueryMaxOrderVolume is NULL else QryMaxOrderVolumeField.from_address(<size_t> pQueryMaxOrderVolume).to_dict(),
                                      {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                      nRequestID,
                                      bIsLast)
    except Exception as err_msg:
...
# ///请求查询分类合约响应
cdef extern int   TraderSpi_OnRspQryClassifiedInstrument(self, CThostFtdcInstrumentField *pInstrument,
                                                               CThostFtdcRspInfoField *pRspInfo,
                                                               int nRequestID,
                                                               bool bIsLast) except -1:
    try:
        self.OnRspQryClassifiedInstrument({} if pInstrument is NULL else InstrumentField.from_address(<size_t> pInstrument).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryClassifiedInstrument', err_msg)
    return 0

# ///请求组合优惠比例响应
cdef extern int   TraderSpi_OnRspQryCombPromotionParam(self, CThostFtdcCombPromotionParamField *pCombPromotionParam,
                                                             CThostFtdcRspInfoField *pRspInfo,
                                                             int nRequestID,
                                                             bool bIsLast) except -1:
    try:
        self.OnRspQryCombPromotionParam({} if pCombPromotionParam is NULL else CombPromotionParamField.from_address(<size_t> pCombPromotionParam).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryCombPromotionParam', err_msg)
    return 0


# ///投资者风险结算持仓查询响应
cdef extern int   TraderSpi_OnRspQryRiskSettleInvstPosition(self, CThostFtdcRiskSettleInvstPositionField *pRiskSettleInvstPosition,
                                                                  CThostFtdcRspInfoField *pRspInfo,
                                                                  int nRequestID,
                                                                  bool bIsLast) except -1:
    try:
        self.OnRspQryRiskSettleInvstPosition({} if pRiskSettleInvstPosition is NULL else RiskSettleInvstPositionField.from_address(<size_t> pRiskSettleInvstPosition).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRiskSettleInvstPosition', err_msg)
    return 0

# ///风险结算产品查询响应
cdef extern int   TraderSpi_OnRspQryRiskSettleProductStatus(self, CThostFtdcRiskSettleProductStatusField *pRiskSettleProductStatus,
                                                                  CThostFtdcRspInfoField *pRspInfo,
                                                                  int nRequestID,
                                                                  bool bIsLast) except -1:
    try:
        self.OnRspQryRiskSettleProductStatus({} if pRiskSettleProductStatus is NULL else RiskSettleProductStatusField.from_address(<size_t> pRiskSettleProductStatus).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRiskSettleProductStatus', err_msg)
    return 0

# ///SPBM期货合约参数查询响应
cdef extern int   TraderSpi_OnRspQrySPBMFutureParameter(self, CThostFtdcSPBMFutureParameterField *pSPBMFutureParameter,
                                                              CThostFtdcRspInfoField *pRspInfo,
                                                              int nRequestID,
                                                              bool bIsLast) except -1:
    try:
        self.OnRspQrySPBMFutureParameter({} if pSPBMFutureParameter is NULL else SPBMFutureParameterField.from_address(<size_t> pSPBMFutureParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPBMFutureParameter', err_msg)
    return 0

# ///SPBM期权合约参数查询响应
cdef extern int   TraderSpi_OnRspQrySPBMOptionParameter(self, CThostFtdcSPBMOptionParameterField *pSPBMOptionParameter,
                                                              CThostFtdcRspInfoField *pRspInfo,
                                                              int nRequestID,
                                                              bool bIsLast) except -1:
    try:
        self.OnRspQrySPBMOptionParameter({} if pSPBMOptionParameter is NULL else SPBMOptionParameterField.from_address(<size_t> pSPBMOptionParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPBMOptionParameter', err_msg)
    return 0
...
cdef extern int   TraderSpi_OnRspQrySPBMIntraParameter(self, CThostFtdcSPBMIntraParameterField *pSPBMIntraParameter,
                                                             ...
                                                             bool bIsLast) except -1:
    try:
        self.OnRspQrySPBMIntraParameter({} if pSPBMIntraParameter is NULL else SPBMIntraParameterField.from_address(<size_t> pSPBMIntraParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPBMIntraParameter', err_msg)
    return 0

# ///SPBM跨品种抵扣参数查询响应
cdef extern int   TraderSpi_OnRspQrySPBMInterParameter(self, CThostFtdcSPBMInterParameterField *pSPBMInterParameter,
                                                             CThostFtdcRspInfoField *pRspInfo,
                                                             int nRequestID,
                                                             bool bIsLast) except -1:
    try:
        self.OnRspQrySPBMInterParameter({} if pSPBMInterParameter is NULL else SPBMInterParameterField.from_address(<size_t> pSPBMInterParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPBMInterParameter', err_msg)
    return 0


# ///SPBM组合保证金套餐查询响应
cdef extern int   TraderSpi_OnRspQrySPBMPortfDefinition(self, CThostFtdcSPBMPortfDefinitionField *pSPBMPortfDefinition,
                                                              CThostFtdcRspInfoField *pRspInfo,
                                                              int nRequestID,
                                                              bool bIsLast) except -1:
    try:
        self.OnRspQrySPBMPortfDefinition({} if pSPBMPortfDefinition is NULL else SPBMPortfDefinitionField.from_address(<size_t> pSPBMPortfDefinition).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPBMPortfDefinition', err_msg)
    return 0

# ///投资者SPBM套餐选择查询响应
cdef extern int   TraderSpi_OnRspQrySPBMInvestorPortfDef(self, CThostFtdcSPBMInvestorPortfDefField *pSPBMInvestorPortfDef,
                                                               CThostFtdcRspInfoField *pRspInfo,
                                                               int nRequestID,
                                                               bool bIsLast) except -1:
    try:
        self.OnRspQrySPBMInvestorPortfDef({} if pSPBMInvestorPortfDef is NULL else SPBMInvestorPortfDefField.from_address(<size_t> pSPBMInvestorPortfDef).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPBMInvestorPortfDef', err_msg)
    return 0

# ///投资者新型组合保证金系数查询响应
cdef extern int   TraderSpi_OnRspQryInvestorPortfMarginRatio(self, CThostFtdcInvestorPortfMarginRatioField *pInvestorPortfMarginRatio,
                                                                   CThostFtdcRspInfoField *pRspInfo,
                                                                   int nRequestID,
                                                                   bool bIsLast) except -1:
    try:
        self.OnRspQryInvestorPortfMarginRatio({} if pInvestorPortfMarginRatio is NULL else InvestorPortfMarginRatioField.from_address(<size_t> pInvestorPortfMarginRatio).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryInvestorPortfMarginRatio', err_msg)
    return 0

# ///投资者产品SPBM明细查询响应
cdef extern int   TraderSpi_OnRspQryInvestorProdSPBMDetail(self, CThostFtdcInvestorProdSPBMDetailField *pInvestorProdSPBMDetail,
                                                                 CThostFtdcRspInfoField *pRspInfo,
                                                                 int nRequestID,
                                                                 bool bIsLast) except -1:
    try:
        self.OnRspQryInvestorProdSPBMDetail({} if pInvestorProdSPBMDetail is NULL else InvestorProdSPBMDetailField.from_address(<size_t> pInvestorProdSPBMDetail).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryInvestorProdSPBMDetail', err_msg)
    return 0

# ///投资者商品组SPMM记录查询响应
cdef extern int   TraderSpi_OnRspQryInvestorCommoditySPMMMargin(self, CThostFtdcInvestorCommoditySPMMMarginField *pInvestorCommoditySPMMMargin,
                                                                CThostFtdcRspInfoField *pRspInfo,
                                                                int nRequestID,
                                                                bool bIsLast) except -1:
    try:
        self.OnRspQryInvestorCommoditySPMMMargin({} if pInvestorCommoditySPMMMargin is NULL else InvestorCommoditySPMMMarginField.from_address(<size_t> pInvestorCommoditySPMMMargin).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryInvestorCommoditySPMMMargin', err_msg)
    return 0

# ///投资者商品群SPMM记录查询响应
cdef extern int   TraderSpi_OnRspQryInvestorCommodityGroupSPMMMargin(self, CThostFtdcInvestorCommodityGroupSPMMMarginField *pInvestorCommodityGroupSPMMMargin,
                                                                           CThostFtdcRspInfoField *pRspInfo,
                                                                           int nRequestID,
                                                                           bool bIsLast) except -1:
    try:
        self.OnRspQryInvestorCommodityGroupSPMMMargin({} if pInvestorCommodityGroupSPMMMargin is NULL else InvestorCommodityGroupSPMMMarginField.from_address(<size_t> pInvestorCommodityGroupSPMMMargin).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryInvestorCommodityGroupSPMMMargin', err_msg)
    return 0

# ///SPMM合约参数查询响应
cdef extern int   TraderSpi_OnRspQrySPMMInstParam(self, CThostFtdcSPMMInstParamField *pSPMMInstParam,
                                                        CThostFtdcRspInfoField *pRspInfo,
                                                        int nRequestID,
                                                        bool bIsLast) except -1:
    try:
        self.OnRspQrySPMMInstParam({} if pSPMMInstParam is NULL else SPMMInstParamField.from_address(<size_t> pSPMMInstParam).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPMMInstParam', err_msg)
    return 0

# ///SPMM产品参数查询响应
cdef extern int   TraderSpi_OnRspQrySPMMProductParam(self, CThostFtdcSPMMProductParamField *pSPMMProductParam,
                                                           CThostFtdcRspInfoField *pRspInfo,
                                                           int nRequestID,
                                                           bool bIsLast) except -1:
    try:
        self.OnRspQrySPMMProductParam({} if pSPMMProductParam is NULL else SPMMProductParamField.from_address(<size_t> pSPMMProductParam).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPMMProductParam', err_msg)
    return 0

# ///SPBM附加跨品种抵扣参数查询响应
cdef extern int   TraderSpi_OnRspQrySPBMAddOnInterParameter(self, CThostFtdcSPBMAddOnInterParameterField *pSPBMAddOnInterParameter,
                                                                  CThostFtdcRspInfoField *pRspInfo,
                                                                  int nRequestID,
                                                                  bool bIsLast) except -1:
    try:
        self.OnRspQrySPBMAddOnInterParameter({} if pSPBMAddOnInterParameter is NULL else SPBMAddOnInterParameterField.from_address(<size_t> pSPBMAddOnInterParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQrySPBMAddOnInterParameter', err_msg)
    return 0

# ///RCAMS产品组合信息查询响应
cdef extern int   TraderSpi_OnRspQryRCAMSCombProductInfo(self, CThostFtdcRCAMSCombProductInfoField *pRCAMSCombProductInfo,
                                                               CThostFtdcRspInfoField *pRspInfo,
                                                               int nRequestID,
                                                               bool bIsLast) except -1:
    try:
        self.OnRspQryRCAMSCombProductInfo({} if pRCAMSCombProductInfo is NULL else RCAMSCombProductInfoField.from_address(<size_t> pRCAMSCombProductInfo).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRCAMSCombProductInfo', err_msg)
    return 0

# ///RCAMS同合约风险对冲参数查询响应
cdef extern int   TraderSpi_OnRspQryRCAMSInstrParameter(self, CThostFtdcRCAMSInstrParameterField *pRCAMSInstrParameter,
                                                              CThostFtdcRspInfoField *pRspInfo,
                                                              int nRequestID,
                                                              bool bIsLast) except -1:
    try:
        self.OnRspQryRCAMSInstrParameter({} if pRCAMSInstrParameter is NULL else RCAMSInstrParameterField.from_address(<size_t> pRCAMSInstrParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRCAMSInstrParameter', err_msg)
    return 0

# ///RCAMS品种内风险对冲参数查询响应
cdef extern int   TraderSpi_OnRspQryRCAMSIntraParameter(self, CThostFtdcRCAMSIntraParameterField *pRCAMSIntraParameter,
                                                              CThostFtdcRspInfoField *pRspInfo,
                                                              int nRequestID,
                                                              bool bIsLast) except -1:
    try:
        self.OnRspQryRCAMSIntraParameter({} if pRCAMSIntraParameter is NULL else RCAMSIntraParameterField.from_address(<size_t> pRCAMSIntraParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRCAMSIntraParameter', err_msg)
    return 0

# ///RCAMS跨品种风险折抵参数查询响应
cdef extern int   TraderSpi_OnRspQryRCAMSInterParameter(self, CThostFtdcRCAMSInterParameterField *pRCAMSInterParameter,
                                                              CThostFtdcRspInfoField *pRspInfo,
                                                              int nRequestID,
                                                              bool bIsLast) except -1:
    try:
        self.OnRspQryRCAMSInterParameter({} if pRCAMSInterParameter is NULL else RCAMSInterParameterField.from_address(<size_t> pRCAMSInterParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRCAMSInterParameter', err_msg)
    return 0

# ///RCAMS空头期权风险调整参数查询响应
cdef extern int   TraderSpi_OnRspQryRCAMSShortOptAdjustParam(self, CThostFtdcRCAMSShortOptAdjustParamField *pRCAMSShortOptAdjustParam,
                                                                   CThostFtdcRspInfoField *pRspInfo,
                                                                   int nRequestID,
                                                                   bool bIsLast) except -1:
    try:
        self.OnRspQryRCAMSShortOptAdjustParam({} if pRCAMSShortOptAdjustParam is NULL else RCAMSShortOptAdjustParamField.from_address(<size_t> pRCAMSShortOptAdjustParam).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRCAMSShortOptAdjustParam', err_msg)
    return 0

# ///RCAMS策略组合持仓查询响应
cdef extern int   TraderSpi_OnRspQryRCAMSInvestorCombPosition(self, CThostFtdcRCAMSInvestorCombPositionField *pRCAMSInvestorCombPosition,
                                                                    CThostFtdcRspInfoField *pRspInfo,
                                                                    int nRequestID,
                                                                    bool bIsLast) except -1:
    try:
        self.OnRspQryRCAMSInvestorCombPosition({} if pRCAMSInvestorCombPosition is NULL else RCAMSInvestorCombPositionField.from_address(<size_t> pRCAMSInvestorCombPosition).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRCAMSInvestorCombPosition', err_msg)
    return 0

# ///投资者品种RCAMS保证金查询响应
cdef extern int   TraderSpi_OnRspQryInvestorProdRCAMSMargin(self, CThostFtdcInvestorProdRCAMSMarginField *pInvestorProdRCAMSMargin,
                                                                  CThostFtdcRspInfoField *pRspInfo,
                                                                  int nRequestID,
                                                                  bool bIsLast) except -1:
    try:
        self.OnRspQryInvestorProdRCAMSMargin({} if pInvestorProdRCAMSMargin is NULL else InvestorProdRCAMSMarginField.from_address(<size_t> pInvestorProdRCAMSMargin).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryInvestorProdRCAMSMargin', err_msg)
    return 0

# ///RULE合约保证金参数查询响应
cdef extern int   TraderSpi_OnRspQryRULEInstrParameter(self, CThostFtdcRULEInstrParameterField *pRULEInstrParameter,
                                                             CThostFtdcRspInfoField *pRspInfo,
                                                             int nRequestID,
                                                             bool bIsLast) except -1:
    try:
        self.OnRspQryRULEInstrParameter({} if pRULEInstrParameter is NULL else RULEInstrParameterField.from_address(<size_t> pRULEInstrParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRULEInstrParameter', err_msg)
    return 0

# ///RULE品种内对锁仓折扣参数查询响应
cdef extern int   TraderSpi_OnRspQryRULEIntraParameter(self, CThostFtdcRULEIntraParameterField *pRULEIntraParameter,
                                                             CThostFtdcRspInfoField *pRspInfo,
                                                             int nRequestID,
                                                             bool bIsLast) except -1:
    try:
        self.OnRspQryRULEIntraParameter({} if pRULEIntraParameter is NULL else RULEIntraParameterField.from_address(<size_t> pRULEIntraParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRULEIntraParameter', err_msg)
    return 0

# ///RULE跨品种抵扣参数查询响应
cdef extern int   TraderSpi_OnRspQryRULEInterParameter(self, CThostFtdcRULEInterParameterField *pRULEInterParameter,
                                                             CThostFtdcRspInfoField *pRspInfo,
                                                             int nRequestID,
                                                             bool bIsLast) except -1:
    try:
        self.OnRspQryRULEInterParameter({} if pRULEInterParameter is NULL else RULEInterParameterField.from_address(<size_t> pRULEInterParameter).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryRULEInterParameter', err_msg)
    return 0

# ///投资者产品RULE保证金查询响应
cdef extern int   TraderSpi_OnRspQryInvestorProdRULEMargin(self, CThostFtdcInvestorProdRULEMarginField *pInvestorProdRULEMargin,
                                                                 CThostFtdcRspInfoField *pRspInfo,
                                                                 int nRequestID,
                                                                 bool bIsLast) except -1:
    try:
        self.OnRspQryInvestorProdRULEMargin({} if pInvestorProdRULEMargin is NULL else InvestorProdRULEMarginField.from_address(<size_t> pInvestorProdRULEMargin).to_dict(),
                                     {} if pRspInfo is NULL else RspInfoField.from_address(<size_t> pRspInfo).to_str_dict(),
                                     nRequestID,
                                     bIsLast)
    except Exception as err_msg:
        self.write_log('OnRspQryInvestorProdRULEMargin', err_msg)
    return 0
